      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a href="#!" class="text-gray-600">Vegetable</a>
            </p>
            <p className="mb-4">
              <a href="#!" class="text-gray-600">Friut</a>
            </p>
            <p className="mb-4">
              <a href="#!" class="text-gray-600">Cleaning agent</a>
            </p>
            <p>
              <a href="#!" class="text-gray-600">Drinks</a>
            </p>
          </div>
